...
# omg we are hunting for the top-secret dot-env file in this directory or the mom and dad directory above us
...
def test_groq():
    ...
    try:
        ...
        # let's make a super quick chat completion to see if the groq key is actually working or if it's just fake news
...
def test_supabase():
    ...
    try:
        ...
        # let's initialize the client to see if it does a faceplant or if it's completely ready to roll
