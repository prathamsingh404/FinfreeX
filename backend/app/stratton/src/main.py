"""bruh this is the main button to start the entire ai hedge fund system! buckle up we are going to the moon!"""
...
def display_results(final_state: dict) -> None:
    """omg we are printing super pretty tables to show how much fake money we made or lost! we are using rich tables because ugly text is for boomers!"""
    data = final_state.get("data", {})

    # ── Analyst Signals but make it super colorful ─────────────────────────────────────────
    ...
    # ── Risk Adjusted (safety first guys) ───────────────────────────────────────────
    ...
    # ── Portfolio Decisions (buying time baby) ─────────────────────────────────────
