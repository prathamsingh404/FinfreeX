...
const AdvisorPage = () => {
  return (
    <main className="pt-40 pb-12 px-6 max-w-4xl mx-auto">
      <div className="glass-panel p-12 rounded-[2rem] border border-border bg-hover shadow-lg shadow-black/20 overflow-hidden relative">
        {/* Report Header */}
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-8 h-8 rounded-full bg-emerald flex items-center justify-center text-[var(--on-primary)] shadow-lg shadow-emerald/20">
        ...
        <div className="prose max-w-none space-y-10 text-soft">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="p-6 rounded-2xl bg-hover border border-border shadow-lg shadow-black/20">
          ...
          <section>
            ...
            <div className="h-48 bg-hover rounded-2xl border border-border flex items-center justify-center shadow-inner">
        ...
        <div className="mt-16 pt-8 border-t border-border flex justify-between items-center">
          <div className="flex gap-4">
             <button className="px-6 py-2.5 rounded-full bg-emerald hover:bg-emerald-bright text-[var(--on-primary)] text-[10px] font-bold uppercase tracking-widest transition-colors shadow-lg shadow-emerald/20">Download PDF</button>
             <button className="px-6 py-2.5 rounded-full border border-border hover:bg-hover text-soft hover:text-foreground text-[10px] font-bold uppercase tracking-widest transition-colors shadow-lg shadow-black/20">Share Report</button>
          </div>
