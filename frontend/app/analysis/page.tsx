    ...
    <main className="pt-36 pb-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="glass-panel p-6 rounded-[2rem] border border-border bg-hover shadow-lg shadow-black/20 relative overflow-hidden">
            <h3 className="text-xs font-bold text-foreground font-mono uppercase tracking-widest mb-6">Manage Assets</h3>

            <div className="space-y-4 mb-8">
              <button className="w-full flex items-center justify-center gap-2 py-3 rounded-full border border-dashed border-border text-[10px] font-mono font-bold uppercase tracking-widest text-soft hover:border-emerald-bright hover:text-emerald-bright transition-all duration-300">
              ...
              <button className="w-full py-3 rounded-full bg-emerald hover:bg-emerald-bright text-[var(--on-primary)] text-[10px] font-mono font-bold uppercase tracking-widest transition-colors duration-300 shadow-md">
                Add Asset Manually
              </button>
            </div>
            ...
            <div className="space-y-3">
              ...
              {assets.map((asset, i) => (
                <div key={i} className="flex justify-between items-center p-4 rounded-2xl bg-hover border border-border shadow-lg shadow-black/20">
                  <div>
          ...
          <div className="glass-panel p-6 rounded-[2rem] border border-border bg-hover shadow-lg shadow-black/20">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-panel p-8 rounded-[2rem] border border-border bg-hover shadow-lg shadow-black/20 relative overflow-hidden">
            ...
            <div className="aspect-[21/9] bg-hover rounded-[2rem] border border-border flex items-center justify-center mb-8 shadow-inner">
               <p className="text-muted/40 font-mono font-bold text-[10px] uppercase tracking-widest italic">Dynamic Allocation Chart</p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-2 border-t border-border">
               <div>
          ...
          <div className="glass-panel p-8 rounded-[2rem] border border-border bg-hover shadow-lg shadow-black/20">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={asset.symbol} className="flex gap-4 p-4 rounded-2xl bg-hover border border-border shadow-lg shadow-black/20 items-start">
                   <div className="w-12 h-12 rounded-xl bg-emerald text-[var(--on-primary)] flex items-center justify-center font-bold font-mono text-sm shrink-0 shadow-sm">{asset.symbol}</div>
                   <div className="pt-1">
