      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-10 fade-up">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center shadow-lg shadow-indigo-500/20">
            <iconify-icon icon="solar:newspaper-linear" width="24"></iconify-icon>
          </div>
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-100 mb-1">News & Sentiment</h1>
            <p className="text-slate-500 text-sm">Institutional-grade intelligence for news & sentiment.</p>
          </div>
        </div>
