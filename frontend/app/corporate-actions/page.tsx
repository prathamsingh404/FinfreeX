    ...
    <div className="w-full h-full relative z-10 pt-32 px-6 pb-16">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-10 fade-up">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-100 mb-1">Corporate Actions</h1>
            <p className="text-slate-500 text-sm">Institutional-grade intelligence for corporate actions.</p>
          </div>
        </div>
